...
/**
 * The class {@code BuyBox} defines the controller for the buy_popup.fxml.
 * <p>
 * It allows the customer to buy some bottles of wine or to notify to the seller
 * that he needs more bottles than there are available.
 */
public class BuyBox
{
	...
	/**
	 * It allows to buy some bottles of wine. It sends a request to the server
	 * containing the number of bottles, the customerID and the wineID.
	 */
	public void buy()
	{
	...
	private void display()
	{
		...
		try
		{
			root = FXMLLoader.load(getClass().getResource("../res/buy_popup.fxml"));
	...
	/**
	 * It allows to notify the seller that the customer needs some bottles of wine
	 * that aren't available. It sends a request to the server containing the number
	 * of bottles, the customerID and the wineID.
	 */
	...
	/**
	 * If there are some bottles of a certain wine populates the amountChoiceBox
	 * with the number of available bottles and sets not visible the notifyButton
	 * and the notificationTextField.
	 * <p>
	 * If there aren't bottles of a certain wine it set not visible the
	 * amountChoiceBox and the buyButton.
	 */
	...
	/**
	 * It shows the notifictionTextField where is possible to set the number of
	 * bottles that you want to order and the notifyButton that allows to send a
