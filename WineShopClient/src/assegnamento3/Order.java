...
/**
 * The class {@code Order} contains the information regarding a Customer order. <p>
 * It has a unique ID, the email of the customer, the name of the wine that was ordered, and the amount that was bought. <p>
