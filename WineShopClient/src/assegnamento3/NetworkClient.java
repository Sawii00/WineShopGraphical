...
/**
 * The class {@code NetworkClient} is responsible for establishing a connection to the server, sending requests, and receive responses. 
 **/
public class NetworkClient
{
    ...
    /**
     * Sends a request to the server and waits for a response. <p>
