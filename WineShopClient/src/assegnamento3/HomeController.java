...
/**
 * The class {@code HomeController} defines the controller for the home.fxml.<p>
 * It allows the user to have a graphical representation of the wines. <p>
 */
public class HomeController implements Initializable
{
	...
	/**
	 * Handles the animation that allows the scene displayed when the program is opened to scroll up.
